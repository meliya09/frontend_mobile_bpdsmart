...
import 'package:bpdsmart_diy/models/Informasi/detail_lokasi_layanan.dart';
...
class DetailLokasiLayananService {
  ...
  final httpClient = http.Client();
  final apiUrl = '${baseUrl}detaillokasilayanan';

  Future<List<DetailLokasiLayanan>> getDetailLokasiLayanan() async {
    final response = await httpClient.get(Uri.parse(apiUrl));
    if (response.statusCode == 200) {
      final data = detailLokasiLayananFromJson(response.body);
