...
class LayerOneKonvenView extends GetView<LayerOneKonvenController> {
  LayerOneKonvenView({Key? key}) : super(key: key);
      ...
      body: SingleChildScrollView(
        child: SafeArea(
          child: Container(
            ...
            child: Column(
              children: [
                GetBuilder<LayerOneKonvenController>(
                  init: LayerOneKonvenController(),
                  builder: (_) {
                    return nestedFuture();
                  },
                ),
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  onTap: () {
                    ...
                    } else if (snapshot.data![index].kategoriNama == 'Menu') {
                      Get.toNamed(
                        Routes.LAYER_TWO_KONVEN,
                        arguments: snapshot.data![index],
                      );
                    }
                    // else {
                    //   Get.toNamed(Routes.LAYER_TWO_KONVEN,
                    //       arguments: snapshot.data![index]);
                    // }
                  },
                ),
