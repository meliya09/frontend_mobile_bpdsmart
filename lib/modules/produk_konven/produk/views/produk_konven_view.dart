...
class ProdukKonvenView extends GetView<ProdukKonvenController> {
  const ProdukKonvenView({Key? key}) : super(key: key);
  @override
    ...
    return Scaffold(
        ...
        body: Container(
          ...
          child: Column(
            ...
            children: [
              GetBuilder<ProdukKonvenController>(
                init: ProdukKonvenController(),
                builder: (_) {
                          ...
                          itemBuilder: (context, index) {
                            return Card(
                              ...
                              child: ListTile(
                                ...
                                onTap: () {
                                  Get.toNamed(Routes.LAYER_SATU_KONVEN,
                                      arguments:
