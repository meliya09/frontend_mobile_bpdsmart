...
class LayerDuaKonvenView extends GetView<LayerDuaKonvenController> {
  LayerDuaKonvenView({Key? key}) : super(key: key);
      ...
      body: SingleChildScrollView(
        child: SafeArea(
          child: Container(
            ...
            child: Column(
              children: [
                GetBuilder<LayerDuaKonvenController>(
                  init: LayerDuaKonvenController(),
                  builder: (_) {
                    return nestedFuture();
                  },
                ),
                ...
                child: ListTile(
                  ...
                  onTap: () {
                    if (snapshot.data![index].kontenDeskripsi == null ||
                      ...
                      Get.toNamed(Routes.LAYER_TIGA_KONVEN,
                          arguments: snapshot.data![index]);
                    }
                  },
                ),
