...
List<InfoManajemen> infoManajemenFromJson(String str) =>
    List<InfoManajemen>.from(
        json.decode(str).map((x) => InfoManajemen.fromJson(x)));

String infoManajemenToJson(List<InfoManajemen> data) =>
...
class InfoManajemen {
  ...
  factory InfoManajemen.fromJson(Map<String, dynamic> json) => InfoManajemen(
