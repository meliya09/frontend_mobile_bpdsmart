...
List<StdLayanan> stdLayananFromJson(String str) =>
    List<StdLayanan>.from(json.decode(str).map((x) => StdLayanan.fromJson(x)));

String stdLayananToJson(List<StdLayanan> data) =>
...
class StdLayanan {
  ...
  factory StdLayanan.fromJson(Map<String, dynamic> json) => StdLayanan(
