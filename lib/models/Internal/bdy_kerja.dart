...
List<BdyKerja> bdyKerjaFromJson(String str) =>
    List<BdyKerja>.from(json.decode(str).map((x) => BdyKerja.fromJson(x)));

String bdyKerjaToJson(List<BdyKerja> data) =>
...
class BdyKerja {
  ...
  factory BdyKerja.fromJson(Map<String, dynamic> json) => BdyKerja(
