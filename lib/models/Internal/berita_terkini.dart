...
List<BeritaTerkini> beritaTerkiniFromJson(String str) =>
    List<BeritaTerkini>.from(
        json.decode(str).map((x) => BeritaTerkini.fromJson(x)));

String beritaTerkiniToJson(List<BeritaTerkini> data) =>
...
class BeritaTerkini {
  ...
  factory BeritaTerkini.fromJson(Map<String, dynamic> json) => BeritaTerkini(
