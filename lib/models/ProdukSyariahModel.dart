...
List<ProdukSyariahModel> produkSyariahModelFromJson(String str) =>
    List<ProdukSyariahModel>.from(
        json.decode(str).map((x) => ProdukSyariahModel.fromJson(x)));

String produkSyariahModelToJson(List<ProdukSyariahModel> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class ProdukSyariahModel {
  ProdukSyariahModel({
  ...
  factory ProdukSyariahModel.fromJson(Map<String, dynamic> json) =>
      ProdukSyariahModel(
