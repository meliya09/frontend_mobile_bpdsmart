...
List<LokasiATM> lokasiATMFromJson(String str) =>
    List<LokasiATM>.from(json.decode(str).map((x) => LokasiATM.fromJson(x)));

String lokasiATMToJson(List<LokasiATM> data) =>
...
class LokasiATM {
  ...
  factory LokasiATM.fromJson(Map<String, dynamic> json) => LokasiATM(
