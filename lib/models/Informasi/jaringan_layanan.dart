...
List<JaringanLayanan> jaringanLayananFromJson(String str) =>
    List<JaringanLayanan>.from(
        json.decode(str).map((x) => JaringanLayanan.fromJson(x)));

String jaringanLayananToJson(List<JaringanLayanan> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class JaringanLayanan {
  JaringanLayanan({
    this.lokasiId,
    this.kontenId,
    this.lokasiLevel,
  ...
  factory JaringanLayanan.fromJson(Map<String, dynamic> json) =>
      JaringanLayanan(
