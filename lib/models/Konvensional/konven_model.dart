...
List<KonvenModel> konvenModelFromJson(String str) => List<KonvenModel>.from(
    json.decode(str).map((x) => KonvenModel.fromJson(x)));

String konvenModelToJson(List<KonvenModel> data) =>
...
class KonvenModel {
  ...
  factory KonvenModel.fromJson(Map<String, dynamic> json) => KonvenModel(
