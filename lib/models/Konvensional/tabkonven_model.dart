...
List<TabkonvenModel> tabkonvenModelFromJson(String str) =>
    List<TabkonvenModel>.from(
        json.decode(str).map((x) => TabkonvenModel.fromJson(x)));

String tabkonvenModelToJson(List<TabkonvenModel> data) =>
...
class TabkonvenModel {
  ...
  factory TabkonvenModel.fromJson(Map<String, dynamic> json) => TabkonvenModel(
