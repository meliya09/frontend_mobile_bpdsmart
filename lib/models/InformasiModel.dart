...
List<InformasiModel> informasiModelFromJson(String str) =>
    List<InformasiModel>.from(
        json.decode(str).map((x) => InformasiModel.fromJson(x)));

String informasiModelToJson(List<InformasiModel> data) =>
