...
List<SimulasiModel> simulasiModelFromJson(String str) =>
    List<SimulasiModel>.from(
        json.decode(str).map((x) => SimulasiModel.fromJson(x)));

String simulasiModelToJson(List<SimulasiModel> data) =>
