...
List<InternalModel> internalModelFromJson(String str) =>
    List<InternalModel>.from(
        json.decode(str).map((x) => InternalModel.fromJson(x)));

String internalModelToJson(List<InternalModel> data) =>
...
class InternalModel {
  ...
  factory InternalModel.fromJson(Map<String, dynamic> json) => InternalModel(
