...
List<DanaSyariah> danaSyariahFromJson(String str) => List<DanaSyariah>.from(
    json.decode(str).map((x) => DanaSyariah.fromJson(x)));

String danaSyariahToJson(List<DanaSyariah> data) =>
...
class DanaSyariah {
  ...
  factory DanaSyariah.fromJson(Map<String, dynamic> json) => DanaSyariah(
