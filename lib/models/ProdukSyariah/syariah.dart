...
List<Syariah> syariahFromJson(String str) =>
    List<Syariah>.from(json.decode(str).map((x) => Syariah.fromJson(x)));

String syariahToJson(List<Syariah> data) =>
...
class Syariah {
  ...
  factory Syariah.fromJson(Map<String, dynamic> json) => Syariah(
