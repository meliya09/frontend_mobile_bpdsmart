...
//
//     final konven = konvenFromJson(jsonString);

// ignore_for_file: unnecessary_null_in_if_null_operators

import 'dart:convert';

List<Konven> konvenFromJson(String str) =>
    // ignore: always_specify_types
    List<Konven>.from(json.decode(str).map((x) => Konven.fromJson(x)));

String konvenToJson(List<Konven> data) =>
    json.encode(List<dynamic>.from(data.map((Konven x) => x.toJson())));
...
class Konven {
  ...
  factory Konven.fromJson(Map<String, dynamic> json) => Konven(
